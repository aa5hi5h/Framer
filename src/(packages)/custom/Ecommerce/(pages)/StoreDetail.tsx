    ...
    return (
        ...
        <div className="flex justify-center items-center pb-2">
            ...
            <div className="flex gap-8 mt-4 items-center ml-[-1rem]">
                ...
                <div className="flex flex-col items-center ">
                    <h2 className="text-lg font-semibold">$1.5k</h2>
                    <h2 className="text-sm font-medium">Sales</h2>
                </div>
            </div>
            </div>
        </div>
        <div className="flex flex-col space-y-4 mb-[4rem] pt-[1.3rem]">
                <div className="flex justify-between items-center">
                    <span className="flex flex-col space-y-1">
                        <h1 className="text-2xl font-bold tracking-tight">Popular products</h1>
                    </span>
                </div>
            ...
            <div className="flex flex-col space-y-4 mb-[1rem] pt-[5.7rem] mx-[0.7rem]">
                <div className="flex justify-between items-center">
                    <span className="flex flex-col space-y-1">
