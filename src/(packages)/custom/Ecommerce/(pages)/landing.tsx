...
interface EcommerceLandingProp{
    viewMode: string
}

const EcommerceLanding = ({viewMode}:EcommerceLandingProp) => {
    ...
    return (
        <div className={`flex flex-col space-y-4 w-full`}>
            ...
            <div className="p-4">
            <div className="flex flex-col space-y-4 max-w-4xl mb-[14.5rem] mx-auto mt-[4.3rem]">
                    <h1 className="text-3xl font-bold text-center tracking-tight">Foundation for your commerce platform</h1>
