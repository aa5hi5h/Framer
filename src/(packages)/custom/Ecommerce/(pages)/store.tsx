...
interface EcommerceStoreProp{
    viewMode: string
}
const EcommerceStore = ({viewMode}:EcommerceStoreProp) => {
...
if(viewMode === "monitor"){
    ...
    return (
        ...
        <div className="flex flex-col space-y-4 mb-[4rem] mx-[0.7rem]">
            ...
            <div className="flex flex-col space-y-4 mb-[1rem] mx-[0.7rem]">
                <div className="flex justify-between items-center">
                    <span className="flex flex-col space-y-2">
            ...
            <div className=" flex justify-center items-center h-[30vh]  w-[120vh] mx-auto rounded-t-lg bg-blue-200">
                <h1 className="px-4 py-2 bg-black text-white text-sm rounded-full flex items-center gap-1">Urban Styles<ArrowUpRight /></h1>
            </div>
            <div className="flex flex-col w-[120vh] rounded-b-lg mx-auto border-[1px] border-blue-200 p-4">
        ...
        <div className="flex flex-col space-y-4 mb-[4rem] mx-[0.7rem]">
                <div className="flex justify-between items-center">
                    <span className="flex flex-col space-y-1">
                        <h1 className="text-2xl font-bold tracking-tight">Trending store&apos;s this week</h1>
                        <p className="text-sm text-slate-700">lore mipsum Neque porro quisquam est qui dolorem ipsum quia dolor</p>
                    </span>
                </div>
            ...
            <div className="flex flex-col space-y-4 mb-[4rem] mx-[0.7rem]">
                <div className="flex justify-between items-center">
                    <span className="flex flex-col space-y-1">
                        <h1 className="text-2xl font-bold tracking-tight">Store&apos;s having sales</h1>
                    </span>
                </div>
                <div className="grid grid-cols-2 gap-4 mt-8">
                    {
            ...
            <div className="flex flex-col space-y-4 mb-[1rem] mx-[0.7rem]">
                <div className="flex justify-between items-center">
                    <span className="flex flex-col space-y-1">
                        <h1 className="text-2xl font-bold tracking-tight">Featured Store</h1>
                    </span>
                </div>
                <div className="flex flex-col  ">
            <div className=" flex justify-center items-center h-[30vh] w-full mx-auto rounded-t-lg bg-blue-200">
                <h1 className="px-4 py-2 bg-black text-white text-sm rounded-full flex items-center gap-1">Urban Styles<ArrowUpRight /></h1>
            </div>
            <div className="flex flex-col w-full rounded-b-lg mx-auto border-[1px] border-blue-200 p-4">
                <h1 className="text-2xl font-bold tracking-tight ">Products</h1>
                <div className=" flex gap-[4rem] px-2 py-2 ">
                <div className="overflow-hidden">
                <motion.div className="grid grid-cols-2 md:grid-cols-5 gap-6 mt-8 px-4" ref={ref} style={{x:xStyles}}
                onHoverStart={() => {
                    setMustFinish(true)
